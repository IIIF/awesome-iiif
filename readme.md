...
- [Cantaloupe](https://github.com/medusa-project/cantaloupe) image server written in Java.  [Getting Started](https://medusa-project.github.io/cantaloupe/get-started.html) guide.
